...
> 2026-05-12 更新：管理员后台已整合餐厅管理模块，现可在同一套管理员导航中进入宿舍管理与餐厅管理；餐厅模块请求默认指向 `http://39.98.69.153:8081/api`，保留原有接口路径不变。
> 2026-05-12 更新：原管理员左侧导航栏中的“餐厅系统”外部跳转入口已升级为站内“餐厅管理”模块，切换时不再整页跳离当前后台。
