...
import { studentMealMonthPageService } from '../api/studentMealWaste.js'
const tableData = ref([])
//搜索表单数据
...
const page1 = async () => {
    const params = {
      ...
      monthCode: searchForm.value.monthCode?.trim() || undefined
    }
    console.log(params)
    const result = await studentMealMonthPageService(params)
...
<template>
   <div class="S-search">
    <el-form :inline="true" :model="searchForm" class="demo-form-inline">
      <el-form-item label="">
        <el-input
          v-model="searchForm.monthCode"
          placeholder="请输入第几年的第几月(202616)"
          clearable
        />
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="tableData" style="width: 100%">
      <el-table-column prop="monthCode" label="月编码" width="120" />
