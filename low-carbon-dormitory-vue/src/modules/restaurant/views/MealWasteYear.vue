...
import { studentMealYearPageService } from '../api/studentMealWaste.js'
const tableData = ref([])
//搜索表单数据
...
const page1 = async () => {
    const params = {
      ...
      yearCode: searchForm.value.yearCode?.trim() || undefined
    }
    console.log(params)
    const result = await studentMealYearPageService(params)
...
<template>
   <div class="S-search">
    <el-form :inline="true" :model="searchForm" class="demo-form-inline">
      <el-form-item label="">
        <el-input
          v-model="searchForm.yearCode"
          placeholder="请输入第几年(yearCode)"
          clearable
        />
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="tableData" style="width: 100%">
      <el-table-column prop="yearCode" label="年编码" width="120" />
