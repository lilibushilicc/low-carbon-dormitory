...
import { studentMealTermPageService } from '../api/studentMealWaste.js'
const tableData = ref([])
//搜索表单数据
...
const page1 = async () => {
    const params = {
      ...
      termCode: searchForm.value.termCode?.trim() || undefined
    }
    console.log(params)
    const result = await studentMealTermPageService(params)
...
<template>
   <div class="S-search">
    <el-form :inline="true" :model="searchForm" class="demo-form-inline">
      <el-form-item label="">
        <el-input
          v-model="searchForm.termCode"
          placeholder="请输入第几学期(2025-2026-2)"
          clearable
        />
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="tableData" style="width: 100%">
      <el-table-column prop="termCode" label="学期编码" width="120" />
